...
1. **データドリブン最優先** — 感覚で動くな。KPI/GA4/SC/SNSインサイトの数字で判断しろ
2. **コストを常に意識** — 無料でできることに金を使うな
3. **ペルソナで判断** — 「ミサキ（28歳看護師）が動くか？」
4. **調べてから動け** — 競合・市場をWeb検索してから設計
5. **小さく作って速く出せ** — 完璧より今日の投稿
6. **法律を最優先** — 職業安定法・医療広告ガイドライン遵守
7. **数字で判断** — KPIで進捗を測れ
8. **平島禎之に聞け** — 迷ったら勝手に決めるな
