...
SLACK_CHANNEL_REPORT = os.getenv("SLACK_CHANNEL_REPORT", os.getenv("SLACK_CHANNEL_ID", "C09A7U4TV4G"))
SLACK_CHANNEL_POST_REVIEW = os.getenv("SLACK_CHANNEL_POST_REVIEW", os.getenv("SLACK_CHANNEL_ID", "C09A7U4TV4G"))
