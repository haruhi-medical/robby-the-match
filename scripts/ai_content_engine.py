#!/usr/bin/env python3
"""
ai_content_engine.py — 神奈川ナース転職 自律型AIコンテンツ生成エンジン v1.0
...
CONTENT_STOCK_HINTS = {
    ...
    "給与": [
        "応援ナースの時給3,000円。同じ病棟で常勤の自分は時給換算1,500円。同じ仕事なのになぜ？",
        "夜勤専従なら月10回で手取り35万。でも体がもつのは何年？",
        "美容クリニックに転職した同期が月収40万。急性期5年目の自分は24万",
        "派遣看護師の時給2,200円。常勤の自分の時給換算は1,500円。ボーナスで取り返せてる？",
        "夜勤1回の手当8,000円。16時間拘束で時給換算500円。深夜コンビニの半分以下",
        "訪問看護に転職したら年収は下がったけど、オンコール手当で月3万入る。QOLは上がった",
        "産業看護師（企業ナース）の年収500万。病棟5年目の自分は380万。何が違う？",
        "紹介会社の手数料135万。それ、看護師の年間ボーナスとほぼ同額",
        "クリニック日勤のみで手取り22万。夜勤ありの病棟と2万しか変わらないなら？",
        "ICU5年目で年収480万。一般病棟5年目は380万。同じ看護師免許で100万差",
    ],
    "地域ネタ": [
        ...
        "川崎の大学病院と小田原の市民病院、同じ5年目で年収80万差。立地だけでこんなに違う？",
    ],
    "転職": [
...
3枚目: Data — ロビー初登場。「ロビーが調べたんだけど」とデータ提示
