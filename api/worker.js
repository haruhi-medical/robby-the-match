...
// ---------- 外部公開求人データ（ハローワークAPI 2026-03-15更新） ----------
...
const EXTERNAL_JOBS = {
  nurse: {
    ...
    "横須賀": [
      ...
      {n:"社会福祉法人　啓生会", t:"看護師　正職員（特別養護老人ホームはまゆう）", r:"A", s:65, d:{sal:25,hol:7,bon:15,emp:15,wel:1,loc:2}, sal:"月給30.0万円", sta:"京急線　三崎口", hol:"107日", bon:"6.0ヶ月", emp:"正社員", wel:"車通勤可"},
    ],
    "鎌倉": [
