...
const EXTERNAL_JOBS = {
  nurse: {
    ...
    "川崎": [
      ...
      {n:"株式会社幸　訪問看護ステーション幸", t:"看護師／契約社員（川崎２号店）", r:"A", s:75, d:{sal:30,hol:20,bon:9,emp:10,wel:1,loc:5}, sal:"月給37.6万円", sta:"ＪＲ横須賀線　新川崎", hol:"125日", bon:"2.0ヶ月", emp:"正社員以外", wel:"車通勤可", desc:"訪問看護ステーションで、健康状態の観察～終末期のケアまで、その他付随する看護師業務全般をお任せします。　　・日常生活自立の支援　・医療的処置・管理　・リハビリテーション看護　・認知症の看護　など　　変更範囲：変更なし　※訪問手段：車・原付バイク・ご自宅の車（貸出有）", loc:"神奈川県川崎市幸区", shift:"(1)9時00分～18時00分"},
      ...
      {n:"社会福祉法人　秀峰会", t:"訪問入浴／看護師　正職員（秋桜の丘）", r:"A", s:71, d:{sal:25,hol:10,bon:15,emp:15,wel:1,loc:5}, sal:"月給34.3万円", sta:"横浜市営地下鉄グリーンライン　北山田", hol:"114日", bon:"4.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"オペレーター（リーダー）、ケアワーカー、看護師の３人１組にてご利用者宅へ伺い、入浴のお手伝いをする仕事です。（１日平均６～７件）　＊仕事内容　１．ご利用者のバイタルチェック（入浴の前後）２．衣類の着脱介助、移動介助のサポート、入浴介助　３．入浴前後の処置（保湿クリームの塗布など、担当医師からの指示が", loc:"神奈川県川崎市宮前区", shift:"(1)8時30分～17時30分"},
      {n:"一般社団法人　共進会", t:"看護師（正社員）", r:"A", s:70, d:{sal:30,hol:10,bon:9,emp:15,wel:1,loc:5}, sal:"月給40.0万円", sta:"ＪＲ線　武蔵小杉", hol:"112日", bon:"2.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"クリニック（内科）の看護師業務　・患者様対応　・各種施術（注射、採血、点滴等）　・診療の補助　・訪問診療の同行　　患者様の不安を取り除くような丁寧な対応をお願いします　資格：看護師　※臨床経験１年以上ある方　　ブランクのある方もご安心して応募ください　※先輩看護師が丁寧に指導いたします。　　変更の範", loc:"神奈川県川崎市中原区", shift:"(1)8時30分～18時00分"},
    ],
    "相模原": [
    ...
    "藤沢": [
      ...
      {n:"株式会社　昌英", t:"訪問看護師・管理者／藤沢市", r:"A", s:72, d:{sal:25,hol:17,bon:9,emp:15,wel:1,loc:5}, sal:"月給33.0万円", sta:"藤沢", hol:"120日", bon:"2.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"在宅で療養している患者様の訪問看護をお願いいたします。　管理者未経験でも先輩がご指導しますので安心です。　チームワークの良いステーションで在宅支援をお願いいたします。　併設で介護事業所、計画相談事業所があります。　　変更範囲：変更なし", loc:"神奈川県藤沢市", shift:"(1)9時00分～18時00分"},
    ...
    "厚木": [
      ...
      {n:"一般社団法人　宝命", t:"看護師［宝命］厚木サテライト", r:"B", s:59, d:{sal:25,hol:10,bon:6,emp:15,wel:1,loc:2}, sal:"月給33.0万円", sta:"小田急線　本厚木", hol:"110日", bon:"1.4ヶ月", emp:"正社員", wel:"車通勤可", desc:"・訪問看護サービス。利用者様の在宅に行き介護及び医療的ケア。　・一般的な事務作業　　記録や計画書等の作成、電話応対など　＊電話当番は週１回以上、夜間緊急対応は月１回程度です。（要相談）　＊訪問サービスを行う際は会社で車両（軽自動車）を用意します。　＊訪問の範囲は厚木市、伊勢原市、平塚市、秦野市になり", loc:"神奈川県厚木市", shift:"(1)9時00分～18時00分"},
    ...
    "大和": [
      ...
      {n:"医療法人社団　小磯診療所", t:"看護師（大和駅徒歩５分　内科・循環器内科・訪問診療）", r:"B", s:60, d:{sal:15,hol:17,bon:15,emp:10,wel:1,loc:2}, sal:"月給25.0万円", sta:"小田急江ノ島線　相鉄線　大和", hol:"120日", bon:"6.0ヶ月", emp:"正社員以外", wel:"車通勤可", desc:"・内科、循環器内科　訪問診療　・医師診察の補助　・外来診療の看護業務　・電子カルテの入力業務　・訪問診療の補助と訪問看護業務　・社用車の運転有（軽自動車）　・その他診療所に付帯する業務　　変更範囲：変更なし", loc:"神奈川県大和市", shift:"(1)8時30分～18時00分"},
    ...
    "海老名": [
      ...
      {n:"株式会社　ベストライフジャパン", t:"放課後等デイサービス指導員／看護師／海老名２", r:"D", s:33, d:{sal:25,hol:0,bon:0,emp:5,wel:1,loc:2}, sal:"時給2,200円", sta:"小田急・相鉄海老名", hol:"不明", bon:"なし", emp:"パート労働者", wel:"車通勤可", desc:"●重度障がい児童放課後等デイサービス（定員５名）に　　おけるご利用者しているお子さんの健康チェック　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　※変更範囲：変更なし", loc:"神奈川県海老名市", shift:"(1)13時30分～19時00分 / (2)9時00分～18時00分"},
    ...
    "南足柄・開成": [
      ...
      {n:"特定医療法人社団　研精会　　箱根リハビリテーション病院", t:"病棟准看護師【１日７時間勤務】【小田原・御殿場送迎あり】", r:"B", s:59, d:{sal:15,hol:14,bon:12,emp:15,wel:1,loc:2}, sal:"月給25.5万円", sta:"小田原", hol:"119日", bon:"3.2ヶ月", emp:"正社員", wel:"車通勤可", desc:"回復期リハ４４床、療養５５床のいずれかで病棟看護業務を行っていただきます。　○健康チェック　○医師の補助　○注射・点滴　○電子カルテ入力　○その他看護業務全般　＊担当数：平均５名　変更範囲：なし　　☆地域に根ざした穏やかな雰囲気の職場です♪　☆２０～６０代までの各世代の職員が活躍中です！　☆配属先は", loc:"神奈川県足柄下郡箱根町", shift:"(1)9時00分～17時00分 / (2)16時15分～9時15分"},
      ...
      {n:"ＡＬＳＯＫ介護株式会社　第三地域本部", t:"看護師／有料老人ホームすこや家・真鶴", r:"B", s:50, d:{sal:25,hol:7,bon:0,emp:15,wel:1,loc:2}, sal:"月給31.8万円", sta:"ＪＲ東海道線　真鶴", hol:"107日", bon:"なし", emp:"正社員", wel:"車通勤可", desc:"【定員４０名の介護付有料老人ホームの入居者様の健康管理（看護業務）】　・日常の健康管理や簡単な処置がメインの業務です。　・バイタルチェックや服薬管理、提携医療機関との連携など看護面でのサポート　・オンコール対応無し、夜勤もありません　・その他付随する業務　　変更範囲：変更なし", loc:"神奈川県足柄下郡真鶴町", shift:"(1)9時00分～18時00分"},
    ],
  },
  pt: {
    "小田原": [
