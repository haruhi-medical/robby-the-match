...
// ---------- 外部公開求人データ（ハローワークAPI 2026-04-04更新） ----------
...
const EXTERNAL_JOBS = {
  nurse: {
    ...
    "川崎": [
      ...
      {n:"医療法人社団　槿仁会　なかじまクリニック", t:"看護師（日勤）／川崎市川崎区", r:"A", s:74, d:{sal:30,hol:17,bon:9,emp:15,wel:1,loc:2}, sal:"月給36.0万円", sta:"ＪＲ　川崎", hol:"120日", bon:"2.35ヶ月", emp:"正社員", wel:"車通勤可", desc:"＜業務内容＞　透析患者様への処置及びケアをお願いします。　・必要物品、医療器具の準備　・人工透析機械の準備、バイタルチェック　・透析における看護対応（穿刺など）　・日常生活における健康管理や生活指導　など　　変更範囲：なし", loc:"", shift:"(1)8時30分～16時30分 / (2)8時45分～17時00分"},
    ...
    "平塚": [
      ...
      {n:"社会福祉法人　富士白苑", t:"看護師〔平塚富士白苑〕", r:"B", s:53, d:{sal:25,hol:3,bon:9,emp:15,wel:1,loc:0}, sal:"月給33.4万円", sta:"", hol:"103日", bon:"2.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"施設入居者に対する看護業務全般　＊日々のバイタルチェック　＊簡単な処置　＊与薬　＊ドクター往診時の付添い　＊救急搬送までの対応　＊オンコール対応　　　　　＊褥瘡処理、など　◎２０２６年４月より外部オンコール代行を導入、　負担軽減を図ります。　　　変更範囲：変更なし", loc:"神奈川県平塚市", shift:"(1)7時00分～15時30分 / (2)9時00分～17時30分"},
    ],
    "大磯": [
    ...
    "厚木": [
      {n:"医療法人社団みのり会　ふたば整形外科", t:"看護師", r:"A", s:75, d:{sal:25,hol:20,bon:12,emp:15,wel:1,loc:2}, sal:"月給30.0万円", sta:"小田急線　本厚木", hol:"125日", bon:"3.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"整形外科クリニックでの外来業務　　「変更範囲：変更なし」", loc:"", shift:"(1)8時45分～19時00分 / (2)8時45分～15時00分"},
      ...
      {n:"医療法人　雄愛会", t:"看護職　　＜夜勤なし／残業ほぼなし＞", r:"A", s:65, d:{sal:15,hol:20,bon:12,emp:15,wel:1,loc:2}, sal:"月給26.0万円", sta:"小田急線　本厚木", hol:"125日", bon:"3.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"・内科外来クリニックにおける看護業務全般　＊特に糖尿病、腎臓病、生活習慣病（高血圧、高脂血症）、甲状腺　内分泌疾患の治療には力を入れているクリニックです。　　　＊ご希望が有れば訪問看護（日中のみで夜間はありません）業務も　有ります。（手当支給有り）　　（変更範囲：変更なし）", loc:"神奈川県厚木市", shift:"(1)8時30分～18時00分 / (2)8時30分～19時00分"},
    ...
    "小田原": [
      ...
      {n:"医療法人社団　湘星会　　小田原腎内科クリニック", t:"外来看護師（正又准）", r:"B", s:63, d:{sal:20,hol:10,bon:15,emp:15,wel:1,loc:2}, sal:"月給27.5万円", sta:"小田原", hol:"113日", bon:"5.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"・人工透析（腹膜透析を含む）を主体とした看護業務　・透析患者のシャント管理（シャント手術、ＰＴＡ等）　・診療所（無床）での外来診療業務：診療補助・血圧測定・採血等　　変更範囲：変更なし", loc:"", shift:"(1)8時00分～16時00分 / (2)12時30分～20時30分"},
    ...
    "多摩": [
      ...
      {n:"一般社団法人　シーズ", t:"看護師（訪問看護ステーション所属）", r:"A", s:74, d:{sal:30,hol:17,bon:9,emp:15,wel:1,loc:2}, sal:"月給36.0万円", sta:"京王高尾線　めじろ台", hol:"124日", bon:"2.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"□小児専門の訪問介護ステーション　・重症心身障害児及び医療的ケア児等の訪問看護。　　ご利用者様のご自宅を訪問し、発育や発達等の相談、各種カテー　テル、医療機器の管理やご家族の精神的な支援などをお願いいた　します。　　「変更範囲：変更なし」", loc:"", shift:"(1)8時30分～17時30分"},
    ...
    "越谷・草加": [
      ...
      {n:"医療法人　眞幸会　　≪草加川柳地域包括支援センター≫", t:"【地域包括】看護師・保健師（トライアル併用）草加市", r:"B", s:62, d:{sal:30,hol:14,bon:0,emp:15,wel:1,loc:2}, sal:"月給39.0万円", sta:"東武スカイツリーライン　新田駅　ＪＲ武蔵野線...", hol:"119日", bon:"なし", emp:"正社員", wel:"車通勤可", desc:"≪草加川柳地域包括支援センターでのお仕事≫　◇総合相談支援　◇介護予防給付対象者のケアマネジメント全般　◇自宅定期訪問　◇関係機関との連絡調整　等　　　　　　　変更範囲：変更なし", loc:"埼玉県草加市", shift:"(1)8時30分～17時30分"},
      {n:"医療法人　眞幸会　　介護老人保健施設　翔寿苑", t:"【通所リハビリ】看護師（正・准）（トライアル併用求人）", r:"B", s:62, d:{sal:30,hol:14,bon:0,emp:15,wel:1,loc:2}, sal:"月給39.5万円", sta:"東武スカイツリーライン　新田駅　ＪＲ武蔵野線...", hol:"119日", bon:"なし", emp:"正社員", wel:"車通勤可", desc:"≪通所リハビリテーション翔寿苑での看護業務≫　◎日勤のみ・日曜日休み　　利用者様の在宅生活を支えるリハビリと健康管理に特化した通所リハビリテーション（デイケア）でのお仕事です！　業務内容は主にバイタル測定などの健康管理のほか、服薬管理や褥瘡処置等と、排泄介助や入浴介助等も行っていただきます。　様々な", loc:"埼玉県草加市", shift:"(1)8時30分～17時30分"},
    ...
    "千葉": [
      ...
      {n:"社会福祉法人　三和会　特別養護老人ホーム　幕張あじさい苑", t:"看護師", r:"A", s:70, d:{sal:20,hol:17,bon:15,emp:15,wel:1,loc:2}, sal:"月給27.4万円", sta:"ＪＲ　幕張駅、京成幕張", hol:"120日", bon:"4.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"新設の特別養護老人ホーム幕張あじさい苑にて、看護業務全般を行なっていただきます。　・バイタルチェック　・健康管理　・服薬管理　・その他付帯業務　　◎２０２４年４月開設予定の特別養護老人ホームです。　　定員１００名（特養８０名、短期入所２０名）　　変更範囲：変更なし", loc:"", shift:"(1)8時00分～17時00分 / (2)9時00分～18時00分"},
