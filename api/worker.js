...
// ---------- 外部公開求人データ（ハローワークAPI 2026-03-25更新） ----------
...
const EXTERNAL_JOBS = {
  nurse: {
    "横浜": [
      ...
      {n:"医療法人　恵和善隣会", t:"正・准看護師　／上永谷駅　徒歩４分", r:"A", s:78, d:{sal:25,hol:20,bon:12,emp:15,wel:1,loc:5}, sal:"月給31.0万円", sta:"使役地下鉄　上永谷", hol:"133日", bon:"3.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"医院での看護師のお仕事です。患者様の健康をサポートし、医療チームの一員として活躍していただきます。　【主な仕事内容】　・患者様のバイタルサインの測定や健康...", loc:"神奈川県横浜市港南区", shift:"(1)8時30分～18時15分 / (2)8時30分～12時30分"},
    ...
    "平塚": [
      ...
      {n:"くま湘南クリニック", t:"看護師", r:"B", s:64, d:{sal:25,hol:17,bon:4,emp:15,wel:1,loc:2}, sal:"月給32.0万円", sta:"平塚", hol:"120日", bon:"あり", emp:"正社員", wel:"車通勤可", desc:"＜主な業務内容＞　・看護業務（診療介助、患者対応、医師指示による処置、採血・注射、問診）　・消化管内視鏡検査の介助、小外科手術（粉瘤摘出など）の介助　・電...", loc:"", shift:""},
