...
// ---------- 外部公開求人データ（ハローワークAPI 2026-04-07更新） ----------
...
const EXTERNAL_JOBS = {
  nurse: {
    ...
    "川崎": [
      ...
      {n:"医療法人社団　黎明会　新百合ヶ丘ステーションクリニック", t:"正看護師　＊駅至近・年間休日１２５日", r:"A", s:70, d:{sal:20,hol:20,bon:12,emp:15,wel:1,loc:2}, sal:"月給28.0万円", sta:"小田急線　新百合ケ丘", hol:"125日", bon:"3.3ヶ月", emp:"正社員", wel:"車通勤可", desc:"一般外来診療における看護業務を担当していただきます。　（内科・外科・整形外科・皮膚科・婦人科・検診・人間ドック等）　※夜勤はございません。　※仕事内容変更範囲：変更なし", loc:"", shift:"(1)9時00分～18時00分 / (2)9時00分～14時00分"},
    ...
    "相模原": [
      ...
      {n:"社会福祉法人蓬莱会　特別養護老人ホームケアプラザさがみはら", t:"看護師（緑区大島／特養）", r:"B", s:60, d:{sal:20,hol:10,bon:12,emp:15,wel:1,loc:2}, sal:"月給28.0万円", sta:"ＪＲ各線・京王線／橋本", hol:"113日", bon:"3.5ヶ月", emp:"正社員", wel:"車通勤可", desc:"特別養護老人ホームでの看護業務　利用者様健康管理など　　　施設定員　　　１３０名　　ショートステイ　１０名　　○看取り対応のみ、オンコールあり（月０～２日程度）　○夜勤無し　　変更範囲：会社の定める業務", loc:"", shift:"(1)8時30分～17時30分"},
    ],
    "横須賀": [
    ...
    "平塚": [
      ...
      {n:"株式会社　いろどり", t:"看護師／いろどり訪問看護ＲＣＵ", r:"A", s:65, d:{sal:15,hol:17,bon:15,emp:15,wel:1,loc:2}, sal:"月給25.0万円", sta:"ＪＲ東海道線　平塚", hol:"124日", bon:"4.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"＊術後の一定期間、患者様の自宅に訪問し術後の状態確認やトラブ　　ルへのサポートを行います。　＊医療依存の高い方や終末期の方に自宅で安心して生活が送れるよ　　うサポートします。　＊「全ての人に家に帰る選択肢を」をモットーに患者様に寄り添っ　　た看護を行います。　＊訪問エリア：平塚市・伊勢原市、その他近", loc:"神奈川県平塚市", shift:"(1)9時00分～18時00分"},
    ...
    "大磯": [
      ...
      {n:"社会福祉法人　一燈会", t:"看護師〔グレースヒル・湘南〕", r:"B", s:52, d:{sal:25,hol:7,bon:4,emp:15,wel:1,loc:0}, sal:"月給30.0万円", sta:"", hol:"108日", bon:"あり", emp:"正社員", wel:"車通勤可", desc:"介護老人保健施設（一般棟１００床・認知症専門棟３６床）にて、施設内の看護業務（バイタルチェック、お薬の管理、入浴前後処置、入院・通院の付き添い、胃瘻、褥そうケアなど）。　◎医療行為は少なめで、利用者様の在宅復帰までの時間をじっくりと関わることができます。　◎介護・リハビリ職など、様々な職種と連携をと", loc:"神奈川県足柄上郡中井町", shift:"(1)8時30分～17時30分"},
    ],
    "秦野": [
    ...
    "厚木": [
      ...
      {n:"株式会社　いろどり", t:"看護師／いろどり訪問看護リハビリステーション", r:"A", s:65, d:{sal:15,hol:17,bon:15,emp:15,wel:1,loc:2}, sal:"月給25.0万円", sta:"小田急線　本厚木", hol:"124日", bon:"4.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"＊在宅で療養している利用者様の状態観察や医療的ケアリハビリテ　ーションを行います。　＊１人１台ｉｐａｄを支給しており、訪問時や訪問終了後、記録の　入力や書類の作成を行っていただきます。　＊訪問エリア：厚木市・海老名市・座間市・愛川町、その他近隣の　　市町村／社用車：軽自動車　＊自家用車持ち込みの場合", loc:"神奈川県厚木市", shift:"(1)9時00分～18時00分"},
    ...
    "23区": [
      ...
      {n:"医療法人社団　慶洋会", t:"看護師（正・准）日勤のみ／四ツ谷駅より徒歩３分（正社員）", r:"A", s:75, d:{sal:25,hol:20,bon:12,emp:15,wel:1,loc:2}, sal:"月給34.0万円", sta:"ＪＲ・東京メトロ　四ッ谷", hol:"125日", bon:"3.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"（１）外来診療の看護業務　（２）医師診療の補助　　（３）企業検診・企業検診時の検査介助　（４）内視鏡介助　　＊　看　護　師：３～５名（日）　　　　　所　属：７名（内パート４名）　＊１日の患者数：２０～３０人程度　＊　午　　前　：健診・外来　　　午　　後　：外来　　変更範囲：変更なし", loc:"", shift:"(1)9時00分～18時00分"},
    ],
    "多摩": [
      ...
      {n:"医療法人社団　恵友会　三恵病院", t:"看護師（病棟）", r:"A", s:70, d:{sal:20,hol:17,bon:15,emp:15,wel:1,loc:2}, sal:"月給28.4万円", sta:"西武池袋線　秋津駅・ＪＲ武蔵野線　新秋津", hol:"124日", bon:"4.7ヶ月", emp:"正社員", wel:"車通勤可", desc:"＊精神科病棟内看護業務　＊平成２７年に全館竣工した清潔な病院です。　＊ベッドサイドが広く業務がしやすい環境です。　　残業はほぼなく、有休消化率も高いので、幅広い年齢層の職員が　仕事と家庭を両立して活躍しています。　是非ご一緒に働きませんか。　　　業務の変更範囲：変更なし", loc:"", shift:"(1)8時30分～16時30分 / (2)16時10分～0時10分"},
    ],
    "さいたま": [
    ...
    "千葉": [
      ...
      {n:"ほしなが耳鼻咽喉科", t:"看護師　准看護師／花見川区【年間休日１４０日】", r:"A", s:68, d:{sal:30,hol:20,bon:0,emp:15,wel:1,loc:2}, sal:"月給40.0万円", sta:"新検見川", hol:"140日", bon:"なし", emp:"正社員", wel:"車通勤可", desc:"★年間休日１４０日：ワークライフバランスに配慮した職場です！　・耳鼻咽喉科未経験の方も歓迎します！！　　トレーニングによりすぐにできるお仕事です。　・主な仕事：点滴、採血、心電図、オペの介助など　＊３０代～５０代の看護師さんが活躍中です！　＊環境の良いスタッフルームがあります　＊ホテルのようにリラッ", loc:"", shift:"(1)8時00分～17時30分 / (2)8時30分～18時00分"},
    ],
    "船橋・市川": [
