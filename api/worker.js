...
const EXTERNAL_JOBS = {
  nurse: {
    ...
    "川崎": [
      ...
      {n:"医療法人メディカルクラスタ", t:"看護師", r:"A", s:74, d:{sal:30,hol:20,bon:6,emp:15,wel:1,loc:2}, sal:"月給25.0〜35.0万円", sta:"小田急線　「向ヶ丘遊園」", hol:"126日", bon:"1.8ヶ月", emp:"正社員", wel:"車通勤可", desc:"＜訪問看護業務＞　・在宅患者様の体調管理　・患者様、ご家族様への看護・介護の指導や精神的・身体的サポー　ト　・他職種との連携業務など　　変更範囲：会社の定めるすべての業務", loc:"神奈川県川崎市多摩区登戸１７６３　ライフガーデン向ヶ丘２階", shift:"(1)9時00分～18時00分", ctr:"雇用期間の定めなし", ins:"雇用　労災　健康　厚生"},
    ...
    "秦野": [
      ...
      {n:"株式会社日本アメニティライフ協会　花珠の家はだの", t:"看護師＜花珠の家はだの＞　週４日～", r:"C", s:35, d:{sal:25,hol:0,bon:0,emp:5,wel:3,loc:2}, sal:"時給1,810〜2,010円", sta:"小田急小田原線　秦野", hol:"不明", bon:"なし", emp:"パート労働者", wel:"車通勤可、住宅手当/寮", desc:"定員２９名のサービス付き高齢者向け住宅＜花珠の家はだの＞にて　◆看護師を募集いたします。　　・ご利用者様のバイタル、食事・水分量等のチェック　　・服薬管理、機能訓練等　　・往診時の対応、医師指示に合わせる医療処置、病状の把握　　・様子観察及び状態変化時の対応、記録業務等　　・パソコン（ワード・エクセ", loc:"神奈川県秦野市", shift:"(1)8時30分～17時30分", ctr:"雇用期間の定めなし", ins:"雇用　労災　健康　厚生"},
    ],
    "伊勢原": [
      ...
      {n:"医療法人俊慈会　伊勢原たかはし整形外科", t:"正または准看護師", r:"D", s:31, d:{sal:25,hol:0,bon:0,emp:5,wel:1,loc:0}, sal:"時給1,700〜1,800円", sta:"", hol:"不明", bon:"なし", emp:"パート労働者", wel:"車通勤可", desc:"＊整形外科の看護師業務　＊先生の処置の介助　＊物品等の管理等　＊院長と看護師２名で対応しています。　　　　　　　　　　変更範囲：変更なし", loc:"神奈川県伊勢原市", shift:"(1)9時00分～18時30分 / (2)9時00分～14時00分", ctr:"雇用期間の定めあり", ins:"労災"},
    ],
    "厚木": [
      ...
      {n:"株式会社　川島コーポレーション　サニーライフ相模愛川", t:"看護師", r:"B", s:59, d:{sal:25,hol:7,bon:9,emp:15,wel:1,loc:2}, sal:"月給27.0〜30.0万円", sta:"小田急線　本厚木・海老名", hol:"107日", bon:"2.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"＊施設内において入居者の看護全般　　　・処置、バイタル計測　　　　・配薬、通院付添い　　　・医療機関への提出書類作成　・夜勤なし、オンコールなし　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　○ＴＶＣＭでおなじみ有料老人ホーム「サニーライフ」　　グループです。　　全国１６０施設（２０", loc:"神奈川県愛甲郡愛川町春日台４－２－６", shift:"(1)7時30分～16時30分 / (2)8時30分～17時30分", ctr:"雇用期間の定めなし", ins:"雇用　労災　健康　厚生"},
    ],
    "大和": [
    ...
    "多摩": [
      ...
      {n:"医療法人社団　浩央会　国立さくら病院", t:"看護師（病棟）", r:"A", s:72, d:{sal:25,hol:17,bon:12,emp:15,wel:1,loc:2}, sal:"月給20.5〜30.0万円", sta:"ＪＲ中央線　国立", hol:"124日", bon:"3.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"病院の看護業務（点滴・採血含む）　・一般内科病棟での勤務になります。　・患者さんは高齢者が中心です。　　中央線国立駅から徒歩約５分の好立地です。　残業もほとんどありませんので、プライベートとの両立も◎です。　年間休日１２４日で休みは多め。有休消化率もほぼ１００％です。　１食４００円で職員食も提供して", loc:"東京都国立市東１－１９－１０", shift:"(1)8時30分～17時30分 / (2)17時00分～0時00分", ctr:"雇用期間の定めなし", ins:"雇用　労災　健康　厚生"},
    ],
    "さいたま": [
      ...
      {n:"医療法人　舟田クリニック", t:"看護師", r:"A", s:68, d:{sal:15,hol:20,bon:15,emp:15,wel:1,loc:2}, sal:"月給22.0〜23.0万円", sta:"武蔵野線　東浦和", hol:"130日", bon:"5.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"・外来看護師業務全般　・検診における計測、採血、心電図など　・ワクチンの確認、補助等　・胃カメラ介助、機械洗浄、清掃等　・院内薬局の補助　　　【変更範囲：変更なし】", loc:"埼玉県さいたま市緑区東浦和５丁目１３－２", shift:"(1)8時15分～18時15分 / (2)8時15分～13時15分", ctr:"雇用期間の定めなし", ins:"雇用　労災　健康　厚生"},
    ...
    "川口・戸田": [
      ...
      {n:"医療法人　如月会　川口六間クリニック", t:"看護師", r:"B", s:58, d:{sal:15,hol:10,bon:15,emp:15,wel:1,loc:2}, sal:"月給25.1〜26.1万円", sta:"ＪＲ京浜東北線　川口", hol:"112日", bon:"4.2ヶ月", emp:"正社員", wel:"車通勤可", desc:"〇外来・透析室での看護業務　　・診察の介助　・内服薬の作成　・採血・注射・点滴等の処置等　　変更範囲：変更なし", loc:"埼玉県川口市栄町３－１１－２９　正木ビル３Ｆ", shift:"(1)8時00分～16時30分 / (2)8時30分～17時00分", ctr:"雇用期間の定めなし", ins:"雇用　労災　健康　厚生　財形"},
    ],
    "所沢・入間": [
    ...
    "千葉その他": [
      ...
      {n:"越川クリニック（越川陽一）", t:"看護師（正・准）", r:"A", s:70, d:{sal:20,hol:20,bon:12,emp:15,wel:1,loc:2}, sal:"月給25.0〜29.0万円", sta:"ＪＲ佐原", hol:"130日", bon:"3.25ヶ月", emp:"正社員", wel:"車通勤可", desc:"内科・小児科クリニック　・予診　・医師の診察補助　・健康診断や各種検査　・予防接種　・胃・大腸内視鏡検査等の介助　　　　　　　　　　　　　　　　「変更範囲：変更なし」", loc:"千葉県香取市北１－１０－３", shift:"(1)8時15分～17時15分 / (2)9時00分～18時00分", ctr:"雇用期間の定めなし", ins:"雇用　労災　健康　厚生"},
    ],
  },
  pt: {
    "小田原": [
