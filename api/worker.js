...
// ---------- 外部公開求人データ（ハローワークAPI 2026-04-16更新） ----------
...
const EXTERNAL_JOBS = {
  nurse: {
    ...
    "さいたま": [
      ...
      {n:"医療法人　秋葉病院", t:"正看護師（病棟）", r:"B", s:60, d:{sal:20,hol:10,bon:12,emp:15,wel:1,loc:2}, sal:"月給19.3〜27.3万円", sta:"ＪＲ埼京線・武蔵野線　武蔵浦和", hol:"110日", bon:"3.5ヶ月", emp:"正社員", wel:"車通勤可", desc:"病棟看護業務　＊脳神経外科中心で急性期から慢性期に移行する患者さま　　に対する看護業務を行っています。　　＊病床数　５９床（急性期１８床、慢性期４１床）です。　＊地域密着型の二次救急指定病院です。　＊２交替制の受け持ち制で看護体制は１０対１です。　　※ブランクのある方歓迎　　変更範囲：変更なし", loc:"埼玉県さいたま市南区根岸５丁目１３－１０", shift:"(1)8時30分～17時30分 / (2)9時30分～18時30分", ctr:"雇用期間の定めなし", ins:"雇用　労災　健康　厚生"},
    ],
    "川口・戸田": [
