...
const EXTERNAL_JOBS = {
  nurse: {
    ...
    "南足柄・開成": [
      ...
      {n:"医療法人社団　明芳会　北小田原病院", t:"【４／２０イベント】看護師／週３日～★プライベート充実", r:"D", s:33, d:{sal:25,hol:0,bon:0,emp:5,wel:1,loc:2}, sal:"時給1,900円", sta:"小田急小田原線　新松田駅、大雄山線　大雄山", hol:"不明", bon:"なし", emp:"パート労働者", wel:"車通勤可", desc:"・精神科療養病棟及び認知症病棟、内科療養病棟（各病棟スタッフ　２０～３０名のシフト制）の看護業務全般　・卒業１年目・未経験・ブランクのある方でもプリセプター制度に　より安心して自分らしさを活かしながら現場に適応できるよう　サポートします。【変更の範囲】なし　　～メッセージ～　働き方様々！プライベート", loc:"神奈川県南足柄市", shift:""},
    ],
  },
  pt: {
    "小田原": [
