...
// ---------- 外部公開求人データ（ハローワークAPI 2026-03-19更新） ----------
...
const EXTERNAL_JOBS = {
  nurse: {
    ...
    "川崎": [
      ...
      {n:"医療法人社団　和光会", t:"訪問看護師／川崎市川崎区", r:"A", s:77, d:{sal:30,hol:17,bon:9,emp:15,wel:1,loc:5}, sal:"月給36.0万円", sta:"ＪＲ・京急線　川崎", hol:"120日", bon:"2.5ヶ月", emp:"正社員", wel:"車通勤可", desc:"訪問看護による在宅医療　寝たきりの患者様の治療等を行ってもらいます。　　　　　　　　「変更範囲：変更なし」", loc:"神奈川県川崎市川崎区", shift:"(1)8時30分～17時30分"},
      ...
      {n:"医療法人社団理桜会　向ヶ丘胃腸・肛門クリニック", t:"看護師", r:"A", s:72, d:{sal:25,hol:20,bon:9,emp:15,wel:1,loc:2}, sal:"月給30.0万円", sta:"小田急線「向ヶ丘遊園」", hol:"125日", bon:"2.0ヶ月", emp:"正社員", wel:"車通勤可", desc:"採血、心電図、検査説明（内視鏡の検査・手術前説明）　内視鏡検査介助、日帰り手術介助、診察介助　　【変更範囲：会社の定める全ての業務】", loc:"", shift:"(1)8時00分～17時00分 / (2)9時45分～18時45分"},
    ],
    "相模原": [
    ...
    "伊勢原": [
      ...
      {n:"一般社団法人　宝命", t:"看護師［宝命の郷］", r:"B", s:59, d:{sal:25,hol:10,bon:6,emp:15,wel:1,loc:2}, sal:"月給33.0万円", sta:"小田急線　伊勢原", hol:"110日", bon:"1.4ヶ月", emp:"正社員", wel:"車通勤可", desc:"★施設内の利用者への対応　・食事、入浴、着替えの介助等介護業務（デイサービス）　・医療的ケア　・一般的な事務作業　　記録や計画書等の作成、電話応対など　★...", loc:"神奈川県伊勢原市", shift:"(1)9時00分～18時00分"},
