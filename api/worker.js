...
// ---------- 外部公開求人データ（ハローワークAPI 2026-03-26更新） ----------
...
const EXTERNAL_JOBS = {
  nurse: {
    ...
    "茅ヶ崎": [
      ...
      {n:"玉井小児科　玉井　滋", t:"看護師（看護師・准看護師）", r:"D", s:33, d:{sal:25,hol:0,bon:0,emp:5,wel:1,loc:2}, sal:"時給2,200円", sta:"ＪＲ相模線　寒川", hol:"不明", bon:"なし", emp:"パート労働者", wel:"車通勤可", desc:"＊外来診療の補助　　＊採血　　＊点滴　　＊予防接種のワクチン管理と準備　＊器具の消毒　　＊院内清掃　　※ブランクのある方、子育て中の方の応募も歓迎です。　...", loc:"", shift:"(1)9時00分～17時00分 / (2)9時00分～12時00分"},
    ],
    "平塚": [
